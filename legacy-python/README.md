...
这是**全新的Android原生版本**，基于Kotlin开发，实现了**真正的悬浮窗**，无需Kivy/Python依赖，性能更好，兼容性更强。

> ⚠️ **注意**：远程仓库原有的Python/Kivy版本已移动到 `legacy-python` 目录，这是全新重写的Android原生版本。

## ✨ 核心优势

| 特性 | Python/Kivy版本 | Android原生版本 |
|------|----------------|-----------------|
| **运行方式** | 需要Python环境 | 纯原生APK |
| **悬浮窗** | 模拟悬浮窗 | 真正系统悬浮窗 |
| **性能** | 中等 | 优秀 |
| **兼容性** | 需要Kivy库 | 原生兼容 |
| **安装** | 复杂 | 一键安装 |
...
- `app/build/outputs/apk/release/app-release.apk` - 发布版APK

## 📖 详细文档

### [📚 完整说明文档](README_FINAL.md)
包含详细的功能介绍、技术实现、使用指南。

### [🔬 OpenCV集成指南](BUILD_WITH_OPENCV.md)
如何从模拟识别升级到真实OpenCV识别。

## 🔄 版本历史

### v1.0.0 (2026-03-31) - Android原生版发布
- ✅ 基于Kotlin的Android原生实现
- ✅ 真正的系统悬浮窗（TYPE_APPLICATION_OVERLAY）
- ✅ 完整的11步王者荣耀自动化
- ✅ 智能点击策略（找图>找字>坐标）
- ✅ 三层点击实现（ROOT+无障碍+ADB）
- ✅ 实时状态和日志显示
...
### v0.x.x (2026-03-30) - Python/Kivy旧版本
> ⚠️ 已移动到 `legacy-python/` 目录
